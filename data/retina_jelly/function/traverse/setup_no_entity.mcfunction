...
execute store result score $override_executing retina.__variable__ run data get storage retina_jelly:input OverrideExecutingEntity
data remove storage retina_jelly:input OverrideExecutingEntity
execute if data storage retina_jelly:input ExpandEntityHitboxes store result score $expand_entity_hitboxes retina.__variable__ run data get storage retina_jelly:input ExpandEntityHitboxes 480
...
data remove storage retina_jelly:input ExpandEntityHitboxes
...
execute unless data storage retina_jelly:input SetupContext summon minecraft:marker run function retina_jelly:__private__/anonymous/2
execute store result score $input_pitch retina.__variable__ run data get storage retina_jelly:input SetupContext.Rotation[1] 10
execute store result score $input_yaw retina.__variable__ run data get storage retina_jelly:input SetupContext.Rotation[0] 10
execute store result score $X retina.__variable__ run data get storage retina_jelly:input SetupContext.Pos[0] 480
execute store result score $Y retina.__variable__ run data get storage retina_jelly:input SetupContext.Pos[1] 480
execute store result score $Z retina.__variable__ run data get storage retina_jelly:input SetupContext.Pos[2] 480
execute store result score $overflow_check_X retina.__variable__ run data get storage retina_jelly:input SetupContext.Pos[0] 1
execute store result score $overflow_check_Z retina.__variable__ run data get storage retina_jelly:input SetupContext.Pos[2] 1
...
function retina_jelly:math/gimbal_to_vec
...
function retina_jelly:traverse/loop
