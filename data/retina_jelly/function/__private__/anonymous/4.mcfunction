data modify storage retina_jelly:data Pos set from entity @s Pos
execute store result score $entity_frac_X retina.__variable__ run data get storage retina_jelly:data Pos[0] 480
...
execute store result score $entity_frac_Y retina.__variable__ run data get storage retina_jelly:data Pos[1] 480
scoreboard players set $temp retina.__variable__ 480
...
execute store result score $entity_frac_Z retina.__variable__ run data get storage retina_jelly:data Pos[2] 480
scoreboard players set $temp retina.__variable__ 480
...
data remove storage retina_jelly:data Pos
kill @s