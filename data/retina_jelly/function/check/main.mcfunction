...
execute if data storage retina_jelly:input {TargetBlocks:true} run function retina_jelly:check/block/main
execute if data storage retina_jelly:input {TargetEntities:true} run function retina_jelly:check/entity/main
...
execute if score $step retina.__variable__ < $max_depth retina.__variable__ if score $hit_block retina.__variable__ matches 0 if score $hit_entity retina.__variable__ matches 0 run function retina_jelly:traverse/loop