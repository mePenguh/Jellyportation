#> jellyportation:loot/get_target/ancient_city.mcfunction
# 
# @calledby     [A] jellyportation:utility/loot/ancient_city
#

advancement revoke @s only jellyportation:utility/loot/ancient_city
