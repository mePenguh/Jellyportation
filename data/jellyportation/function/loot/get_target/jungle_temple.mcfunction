#> jellyportation:loot/get_target/jungle_temple.mcfunction
# 
# @calledby     [A] jellyportation:utility/loot/jungle_temple
#

advancement revoke @s only jellyportation:utility/loot/jungle_temple

data modify storage jellyportation:main Player.Loot.Chance set value 80
