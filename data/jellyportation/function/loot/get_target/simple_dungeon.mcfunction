#> jellyportation:loot/get_target/simple_dungeon.mcfunction
# 
# @calledby     [A] jellyportation:utility/loot/simple_dungeon
#

advancement revoke @s only jellyportation:utility/loot/simple_dungeon

data modify storage jellyportation:main Player.Loot.Chance set value 20
