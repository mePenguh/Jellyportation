#> jellyportation:loot/get_target/stronghold_corridor.mcfunction
# 
# @calledby     [A] jellyportation:utility/loot/stronghold_corridor
#

advancement revoke @s only jellyportation:utility/loot/stronghold_corridor

data modify storage jellyportation:main Player.Loot.Chance set value 30
