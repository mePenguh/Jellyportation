#> jellyportation:loot/get_target/shipwreck_treasure.mcfunction
# 
# @calledby     [A] jellyportation:utility/loot/shipwreck_treasure
#

advancement revoke @s only jellyportation:utility/loot/shipwreck_treasure
