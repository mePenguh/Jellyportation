#> jellyportation:loot/get_target/vault.mcfunction
# 
# @calledby     [A] jellyportation:utility/loot/vault
#

advancement revoke @s only jellyportation:utility/loot/vault
...
function jellyportation:loot/append/vault with storage jellyportation:main Player.Loot